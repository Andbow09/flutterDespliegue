...
import '/components/menu_alumnos_opciones/menu_alumnos_opciones_widget.dart';
...
class ListaAsignaturasWidget extends StatefulWidget {
  ...
  static String routeName = 'Lista_Asignaturas';
          ...
          child: Stack(
            children: [
              ...
              Align(
                alignment: AlignmentDirectional(1.0, -1.0),
                child: Padding(
                  padding: EdgeInsetsDirectional.fromSTEB(0.0, 65.0, 20.0, 0.0),
                  child: InkWell(
                    splashColor: Colors.transparent,
                    focusColor: Colors.transparent,
                    hoverColor: Colors.transparent,
                    ...
                    onTap: () async {
                      context.pushNamed(
                        AsignaturaCrearWidget.routeName,
                        extra: <String, dynamic>{
                          kTransitionInfoKey: TransitionInfo(
                            hasTransition: true,
                            transitionType: PageTransitionType.fade,
